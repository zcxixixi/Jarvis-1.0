...
import jarvis_assistant.config.doubao_config as config
...
class RealtimeDialogClient:
    ...
    async def connect(self) -> None:
        ...
        self.logid = getattr(self.ws, 'response_headers', getattr(getattr(self.ws, 'response', None), 'headers', {})).get("X-Tt-Logid", "N/A")
    ...
    async def say_hello(self) -> None:
        """发送Hello消息"""
        payload = {
            "content": "你好，先生。我是Jarvis，有什么可以帮助您的？",
        }
